        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case STOP_PREVIEW:
                    ...
                    break;
                case SMILE:
//                    Toast.makeText(live_face.this, "Smile", Toast.LENGTH_LONG).show();
                    ...
                    break;
                case ANGRY:
//                    Toast.makeText(live_face.this, "angry", Toast.LENGTH_LONG).show();
//                    Intent i2=new Intent();
                    ...
                    break;
                case DISGUST:
//                    Toast.makeText(live_face.this, "disgust", Toast.LENGTH_LONG).show();
...
//                    Intent i3=new Intent();
                    ...
                    break;
                case FEAR:
//                    Toast.makeText(live_face.this, "fear", Toast.LENGTH_LONG).show();
...
//                    Intent i4=new Intent();
                    ...
                    break;
                case SAD:
//                    Toast.makeText(live_face.this, "sad", Toast.LENGTH_LONG).show();
...
//                    Intent i5=new Intent();
                    ...
                    break;
                case SURPRISE:
//                    Toast.makeText(live_face.this, "Surprise", Toast.LENGTH_LONG).show();
