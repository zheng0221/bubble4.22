...
//                lyface=new LinearLayout(getContext());
    ...
    private void showBottomDialog() {
        ...
        color1.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
//                bubble.setBackgroundColor(R.color.purple_500);
                bubble.playAnimation();
        ...
        seekBar_v.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                switch (progress){
                    case 1:
                        Log.e("1", "1");
                        sdb.execSQL("update user set speed=20 where userphone=?",new String[]{pphone});
                        bubble.setAnimation("1_1.json");
                        bubble.playAnimation();
                        break;
                    case 2:
                        Log.e("2", "2");
                        sdb.execSQL("update user set speed=40 where userphone=?",new String[]{pphone});
                        bubble.setAnimation("1_2.json");
                        bubble.playAnimation();
                        break;
                    case 3:
                        Log.e("3", "3");
                        sdb.execSQL("update user set speed=60 where userphone=?",new String[]{pphone});
                        bubble.setAnimation("1_3.json");
                        bubble.playAnimation();
                        break;
                    case 4:
                        Log.e("4", "4");
                        sdb.execSQL("update user set speed=80 where userphone=?",new String[]{pphone});
                        bubble.setAnimation("1_4.json");
                        bubble.playAnimation();
                        break;
                    case 5:
                        Log.e("5", "5");
                        sdb.execSQL("update user set speed=100 where userphone=?",new String[]{pphone});
                        bubble.setAnimation("1_5.json");
                        bubble.playAnimation();
                        break;
                    default:
                        break;
